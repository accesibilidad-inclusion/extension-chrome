...
<template>
    <div class="h-full relative">
        ...
        <button v-if="isFloatingButtonVisible" @click="handleFloatingButtonClick"
        ...
        <div style="background-color: #F6C254; font-size: 15px; box-shadow: 0 -6px 6px -1px rgba(0, 0, 0, 0.1), 0 -2px 4px -2px rgba(0, 0, 0, 0.1);"
            ...
            <router-link v-if="$route.path === '/'" to="/elementos" @click="handleRecordingButtonClick">
                Crear nuevo apoyo
            </router-link>
            <router-link v-if="$route.path === '/elementos'" to="/"
