...
<template>
    <div class="h-full">
       ...
       <!--<button 
            class="fixed bottom-4 right-1 flex items-center bg-white shadow-lg rounded-full p-2 border border-black">
            <div class="p-2 flex items-center justify-center mr-2">
                               <img src="../../public/assets/img/copia.svg">  
