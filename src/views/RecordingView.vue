          ...
          <div>
              <div class="flex flex-wrap">
                ...
                <div class="flex items-start">
                    <img src="../../public/assets/img/web.svg" width="50px" alt="Ejemplo de pantalla" class="rounded-lg mr-2" />
                    <div class="flex flex-col">
                        <h4 class="text-lg font-semibold" style="font-size: 12px; color: #004079;">
                  ...
                  <div class="flex-grow break-words">
                      <p class="mb-2 break-words" style="font-size: 16px;">{{ guide.steps[currentStepIndex]?.description || 'Descripción detallada del paso' }}</p>
                      <div>
                          <p style="font-size: 14px;color: #6c6c6c;" v-if="guide.steps[currentStepIndex]?.actionUrl" class="mb-4 break-all">
